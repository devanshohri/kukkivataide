...
export function iconAnimation(element, delay = 0) {
  if (window.innerWidth < 1200) return;
  ...
  document.fonts.ready.then(() => {
    ...
    animatedElements.forEach((element) => {
      ...
      if (animateOnScroll) {
        ...
        // Use threshold from data attribute, fallback to 0.3
        const threshold = parseFloat(element.getAttribute("data-animate-threshold")) || 0.3;
        ...
        // Trigger immediately for non-scroll animations
        switch (animationType) {
          case "scramble":
            scrambleAnimation(element, delay);
            break;
